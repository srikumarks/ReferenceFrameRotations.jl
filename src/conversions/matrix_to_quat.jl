...
# ==============================================================================
#
#   Functions related to the conversion from Matrix to quaternion.
#
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #

export matrix_to_quat

"""
    matrix_to_quat(dcm::Matrix)
...
"""
function matrix_to_quat(dcm::Matrix)
    if  tr(dcm) > 0
        # f = 4 * q0
        f = 2sqrt(tr(dcm) + 1)

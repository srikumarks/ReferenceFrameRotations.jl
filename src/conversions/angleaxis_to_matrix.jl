...
# ==============================================================================
#
#   Functions related to the conversion from Euler angle and axis to Matrix.
#
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #

export angleaxis_to_matrix

"""
    angleaxis_to_matrix(a::Number, v::AbstractVector)
    angleaxis_to_matrix(av::EulerAngleAxis)

Convert the Euler angle `a` [rad] and Euler axis `v` to a Matrix.
...
julia> angleaxis_to_matrix(pi / 2, v)
Matrix{Float64}:
...
```
"""
@inline function angleaxis_to_matrix(a::T1, v::AbstractVector{T2}) where {T1, T2}
    # Check the arguments.
